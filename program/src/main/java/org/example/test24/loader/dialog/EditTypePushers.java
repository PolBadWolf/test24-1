...
//        currentId_loggerUserEdit = callBack.getCurrentId_loggerUser();
    ...
    private void initComponents() {
        ...
        // ---- надписи
        jLabel1 = CreateComponents.getLabel("Тип толкателя", new Font("Times New Roman", 0, 18), 120, 230, 210, 24, true, true);
        frame.add(jLabel1);
        jLabel2 = CreateComponents.getLabel("Усилие на штоке (кг)", new Font("Times New Roman", 0, 18), 30, 310, 190, 24, true, true);
        frame.add(jLabel2);
        jLabel3 = CreateComponents.getLabel("Ход штока (мм)", new Font("Times New Roman", 0, 18), 40, 350, 140, 24, true, true);
        frame.add(jLabel3);
        jLabel4 = CreateComponents.getLabel("Время разжатия (сек)", new Font("Times New Roman", 0, 18), 40, 385, 140, 24, true, true);
        frame.add(jLabel4);
        // ---- поля ввода данных
